    ...
    var templates = function(key, locale) {
        ...
        var tpl = {
            ...
            "lists":
                "<li>" +
                  "<div class='btn-group'>" +
                    "<a class='btn btn-default' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "'>" + locale.lists.unordered + "</a>" +
                    "<a class='btn btn-default' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "'>" + locale.lists.ordered + "</a>" +
                    "<a class='btn btn-default' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "'>" + locale.lists.outdent + "</a>" +
                    "<a class='btn btn-default' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "'>" + locale.lists.indent + "</a>" +
                  "</div>" +
                "</li>",
