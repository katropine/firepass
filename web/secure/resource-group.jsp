    ...
    <jsp:body>
        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="row">
                    <div class="col-md-4"><div class="container-fluid"><h2 class="page-heading resource-groups"><fmt:message key="resource_groups"/></h2></div></div>
                    <div class="col-md-8">
                        <div class="container-fluid">
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <c:if test="${acl.allowUpdate('RESOURCE_GROUP')}">
                                <c:if test="${aclGrp.allowUpdate(gr)}">
